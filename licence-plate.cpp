//based on https://github.com/MasteringOpenCV/code/blob/master/Chapter5_NumberPlateRecognition/DetectRegions.cpp
...
{
   char* filename = argc >= 2 ? argv[1] : (char*)"licence-plate.jpg";

  Mat src = imread( filename, 1 );

  vector<Plate> tmp=DetectRegions::segment(src);
imshow("a",src);
waitKey();
}
